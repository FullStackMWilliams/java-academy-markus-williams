...
// TODO: Update to your MySQL configuration
    ...
    private static void viewAllProperties(PropertyDao dao) {
        try {
            ...
            System.out.println("Error while fetching properties: " +
                    e.getMessage());
        }
    }
    // Option 2: Add a property via user input
    private static void addPropertyFromInput(PropertyDao dao, Scanner
            scanner) {
        try {
            ...
            boolean isAvailable =
                    Boolean.parseBoolean(scanner.nextLine().trim());
            ...
            System.out.println("Database error while adding property: " +
                    e.getMessage());
        }
    }
}